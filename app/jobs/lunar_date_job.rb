class LunarDateJob < ApplicationJob
  ...
  def perform(*args)
    ...
    tpl_text = "【高万强】今天是#{traditional_day},祝你及你家人节日快乐, 心想事成，年年有余"
  ...
  def family_number
    "18382012700, 18808108195, 15882440241, 18981961311, 13308082454, 18203093194, 13340852429, 17788666737, 13996461061, 18782216421"
  end
end